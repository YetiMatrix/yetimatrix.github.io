...
#        User Edit Variables                            #
#########################################################
ADDONTITLE = '[COLOR gold]BlackArrow[/COLOR][COLORcyan]Matrix Wizard[/COLOR]'
BUILDERNAME = 'L.M. @Flechanegra '
EXCLUDES = [ADDON_ID, 'repository.blackarrowmatrix']
...
# Font size of header
FONTHEADER = 'Font14'
HEADERMESSAGE = '[COLOR gold]BlackArrow[/COLOR][COLORcyan]Matrix Wizard[/COLOR]'
