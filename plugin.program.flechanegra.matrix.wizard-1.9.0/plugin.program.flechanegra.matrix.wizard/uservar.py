...
#        User Edit Variables                            #
#########################################################
ADDONTITLE = '[COLOR gold]FlechaNegra[/COLOR] [COLORcyan]Matrix Wizard[/COLOR]'
BUILDERNAME = 'L.M. @Flechanegra '
EXCLUDES = [ADDON_ID, 'repository.FlechaNegra.Matrix']
...
THEME1 = u'[COLOR {color1}][I]([COLOR {color1}]FlechaNegra[/COLOR][COLOR {color2}]Matrix Wizard[COLOR {color1}]) [/I][/COLOR] [COLOR {color2}]{{}}[/COLOR]'.format(color1=COLOR1, color2=COLOR2)
...
HIDECONTACT = 'Yes'
# You can add \n to do line breaks
CONTACT = 'Obrigado por usar FlechaNegra Matrix Wizard.'
# Images used for the contact window.  http:// for default icon and fanart
CONTACTICON = 'https://'
CONTACTFANART = 'https://_'
#########################################################
...
REPOID = 'repository.FlechaNegra.Matrix'
...
# Font size of header
FONTHEADER = 'Font14'
HEADERMESSAGE = '[COLOR gold]FlechaNegra[/COLOR] [COLORcyan]Matrix Wizard[/COLOR]'
# url to image if using Image 424x180
HEADERIMAGE = 'https://meocloud.pt/link/c8e6502a-c8ca-416d-b4a6-d7e970162aae/My%20Post.png/'
# Font for Notification Window
FONTSETTINGS = 'Font13'
# Background for Notification Window
BACKGROUND = 'https://meocloud.pt/link/189dfb0a-e4dc-4b9c-a4ac-6888cacdccdb/My%20Post.jpg/'
#########################################################
